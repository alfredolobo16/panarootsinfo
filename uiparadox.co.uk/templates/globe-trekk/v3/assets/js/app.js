    ...
    gsap: function () {
      ...
      if ($("#hero").hasClass("banner-content-parallax")) {
        ...
        if ($(".banner-caption-title").length) {
          $(".banner-caption-title").wrapInner(
            '<div class="banner-title-parallax"></div>'
          );
      ...
      if ($(".about-trigger-1").length) {
        var sideAnimation1 = gsap.timeline({
          default: { ease: "power2.inOut" },
        });
        sideAnimation1.to(".about-1 .images-area .v-4", {
          rotation: 21,
          duration: 0.3,
        });
        sideAnimation1.to(
          ".about-1 .images-area .v-3",
          { x: "0", duration: 0.3 },
          "<"
        );

        sideAnimation1.to(".about-1 .images-area .v-3", {
          rotation: 15,
          duration: 0.3,
        });
        sideAnimation1.to(".about-1 .images-area .v-2", { x: "0" }, "<");

        sideAnimation1.to(".about-1 .images-area .v-2", {
          rotation: 7,
          duration: 0.3,
        });
        sideAnimation1.to(
          ".about-1 .images-area .v-1",
          { x: "0", duration: 0.3 },
          "<"
        );

        sideAnimation1.to(".about-1 .images-area .v-1", {
          rotation: 2,
          duration: 0.3,
        });
      ...
      if ($(".about-trigger-2").length) {
        var sideAnimation3 = gsap.timeline({
          default: { ease: "power2.inOut" },
        });
        sideAnimation3.to(".about-2 .images-area .v-4", {
          rotation: -21,
          duration: 0.3,
        });
        sideAnimation3.to(
          ".about-2 .images-area .v-3",
          { x: "0", duration: 0.3 },
          "<"
        );

        sideAnimation3.to(".about-2 .images-area .v-3", {
          rotation: -15,
          duration: 0.3,
        });
        sideAnimation3.to(".about-2 .images-area .v-2", { x: "0" }, "<");

        sideAnimation3.to(".about-2 .images-area .v-2", {
          rotation: -7,
          duration: 0.3,
        });
        sideAnimation3.to(
          ".about-2 .images-area .v-1",
          { x: "0", duration: 0.3 },
          "<"
        );

        sideAnimation3.to(".about-2 .images-area .v-1", {
          rotation: -2,
          duration: 0.3,
        });
      ...
      if ($("#searchInput").length) {
        $("#searchInput").on("keyup", function () {
          ...
          $(".item-card").filter(function () {
            var hasMatch =
              $(this).find(".title").text().toLowerCase().indexOf(value) > -1;
